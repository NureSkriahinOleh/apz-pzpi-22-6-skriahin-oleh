...
class SensorTypeListView(generics.ListAPIView):
    """
    GET: возвращает список всех типов сенсоров
    """
...
class CreateSensorLogAPIView(APIView):
    """
    POST: Create log, trigger incident if needed, broadcast FDI
    """
    permission_classes = [AllowAny]
    ...
    def post(self, request, *args, **kwargs):
        ...
        if latest_temp and latest_humidity and latest_gas:
            ...
            # Broadcast sensor log + fdi for this room
            ...
            async_to_sync(channel_layer.group_send)(
                'sensor_logs',
                {
                    ...
                    'data': {
                        ...
                        'fdi': fdi,  # may be None or a float
